...
const (
	...
	JWTTokenMalformed         = "jwt.token.malformed"
	JWTTokenNotValidYet       = "jwt.token.not.valid.yet"
	JWTTokenMissing           = "jwt.token.missing"
	JWTTokenFormatInvalid     = "jwt.token.format.invalid"
	JWTSigningMethodMismatch  = "jwt.signing.method.mismatch"
