...
// NewClientWithMonitor create redis client with the given config and monitor.
func (o *RedisOptions) NewClientWithMonitor(poolMonitor monitor.PoolMonitor) (*redis.Client, error) {
	opts := &db.RedisOptions{
		Addr:         o.Addr,
		Username:     o.Username,
		Password:     o.Password,
